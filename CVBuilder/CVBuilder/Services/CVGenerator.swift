...
struct CVGenerator {
    ...
    func buildCV(with type: CVTemplate, cvConstructor: CVConstructor) -> (doc: PDFDocument, fileData: Data, previewImage: Image)? {
        ...
        case 2:
            return generate2(cvConstructor: cvConstructor)
        case 3:
    ...
    private func generate1(cvConstructor: CVConstructor) -> (doc: PDFDocument, fileData: Data, previewImage: Image)? {
        ...
        nameAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 21.64)!
        ...
        speciallityAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 14.64)!
        ...
        summaryTitleAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 10.41)!
        ...
        workExperienceTitleAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 13.22)!
        ...
        for (index, work) in inity.workExperience.enumerated() {
            ...
            companyAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 10)!
            ...
            locationAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 8.41)!
            ...
            leftDutiesAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 7.81)!
        ...
        educationTitleAnnotation.font = R.font.figtreeRegular.callAsFunction(size: 13.22)!
    ...
    private func generate2(cvConstructor: CVConstructor) -> (doc: PDFDocument, fileData: Data, previewImage: Image)? {
        var inity = cvConstructor
        let workArray: [WorkExperienceInput] = inity.workExperience.reversed().map { input in
            return WorkExperienceInput(
                workStartedDate: input.workStartedDate,
